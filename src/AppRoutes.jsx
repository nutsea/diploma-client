...
export const AppRoutes = ({ getAuthCode, onAuth }) => {
    return (
        <Routes>
            ...
            <Route path="/item/:id" element={<ItemCard onAuth={onAuth} />} />
            <Route path="/catalogue/:category?/:popular?/:brand?/:brandset?" element={<Catalogue />} />
            <Route path="/cart" element={<Cart onAuth={onAuth} />} />
            ...
            <Route path="/payment-and-refund" element={<Refund />} />
