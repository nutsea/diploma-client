...
export const fetchItems = async (category, brands, models, sizes, size_type, prices, sort, limit, page, search) => {
    const { data } = await $host.get('api/item/all', { params: { category, brands, models, sizes, size_type, prices, sort, limit, page, search } })
    return data
}
...
export const checkOrderSize = async (item_uid, size) => {
    const { data } = await $host.get('api/item/size', { params: { item_uid, size } })
    return data
}
...
export const watchItem = async (id) => {
    const { data } = await $host.put('api/item/watch', { id })
    return data
}

export const compareSearchWord = async (search) => {
    const { data } = await $host.get('api/item/searchword', { params: { search } })
    return data
}