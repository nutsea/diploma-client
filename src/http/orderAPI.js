...
export const sendCommonOrder = async (slow_shoes, slow_clothes, fast_shoes, fast_clothes, name, social_media, checked_price, recipient, phone, address, ship_type, is_split, course, fee, promo_code, discount) => {
    const { data } = await $authHost.post('api/order/common', { slow_shoes, slow_clothes, fast_shoes, fast_clothes, name, social_media, checked_price, recipient, phone, address, ship_type, is_split, course, fee, promo_code, discount })
    return data
}
